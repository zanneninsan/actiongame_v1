...
export const NIGHTMARE_LONGRUN_STAGE: StageDefinition = {
  ...
  bonusBlocks: [
    { type: "question", x: 1160, y: 304, reward: "powerJump" },
    { type: "hidden", x: 5320, y: 204, reward: "star" },
    { type: "question", x: 8040, y: 360, reward: "powerSpeed" },
    { type: "hidden", x: 12480, y: 392, reward: "star" },
    { type: "question", x: 16680, y: 244, reward: "dashRing" },
    { type: "breakable", x: 18720, y: 252 },
    { type: "breakable", x: 18784, y: 252 },
    { type: "hidden", x: 20960, y: 392, reward: "powerJump" },
    { type: "question", x: 25860, y: 200, reward: "star" },
    { type: "breakable", x: 29920, y: 344 },
    { type: "breakable", x: 29984, y: 344 },
  ],
  checkpoints: [
    { x: 4700, y: 606 },
    { x: 9200, y: 606 },
