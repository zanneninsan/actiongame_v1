...
export const STAGE_OBJECT_ASSETS = [
  ...
  { key: "stage-character-mint-ribbon", path: "assets/stage_objects/stage_character_mint_ribbon.webp" },
  { key: "stage-character-soda-star", path: "assets/stage_objects/stage_character_soda_star.webp" },
  { key: "stage-character-lilac-moon", path: "assets/stage_objects/stage_character_lilac_moon.webp" },
